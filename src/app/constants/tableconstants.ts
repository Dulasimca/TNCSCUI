...
export class TableConstants {
  ...
  constructor() {
    ...
    this.EInvoice = [
      { header: 'S.No', field: 'SlNo', width: '15px' },
      { header: 'Supply Type Code', field: 'IssuerCode' },
      { header: 'e-comm GSTIN', field: '' },
      { header: 'Igst on Intra', field: '' },
      { header: 'Doument Type', field: '' },
      ...
      { header: 'Buyer Trade Name', field: '' },
      { header: 'Buyer POS', field: '' },
      { header: 'Buyer addr1', field: 'Address1' },
      { header: 'Buyer addr2', field: 'Address2' },
      { header: 'Buyer Location', field: '' },
      { header: 'Buyer pincode', field: 'Pincode' },
      { header: 'Buyer state', field: 'StateCode' },
      { header: 'Buyer Phone Number', field: '' },
      { header: 'Buyer Email ID', field: '' },
      { header: 'Despatch Name', field: '' },
      { header: 'Despatch addr1', field: '' },
      { header: 'Despatch addr2', field: '' },
      { header: 'Despatch Location', field: '' },
      { header: 'Despatch State', field: '' },
      { header: 'Shipping GSTIN', field: '' },
      { header: 'Shipping Leaga Name', field: '' },
      { header: 'Shipping Trade Name', field: '' },
      { header: 'Shipping addr1', field: '' },
      { header: 'Shipping addr2', field: '' },
      { header: 'Shipping Location', field: '' },
      { header: 'Shipping pincode', field: '' },
      { header: 'Shipping state', field: '' },
      { header: 'Sl.NO', field: 'Slno' },
      { header: 'Product Description', field: '' },
      { header: 'Is_Service', field: '' },
      { header: 'HSN Code', field: '' },
      { header: 'Bar Code', field: '' },
      { header: 'Quantity', field: 'NetWeight' },
      { header: 'Free Quantity', field: '' },
      { header: 'Reverse Charge', field: '' },
      { header: 'Unit', field: 'Wtype' },
      { header: 'Unit Price', field: 'Total' },
      { header: 'Gross Amount', field: 'GrandTotal' },
      { header: 'Discount', field: '' },
      { header: 'Pre Tax Value', field: '' },
      { header: 'Taxable Value', field: '' },
      { header: 'GST Rate (%)', field: '' },
      { header: 'Sgst Amt (Rs)', field: '' },
      { header: 'Cgst Amt (Rs', field: '' },
      { header: 'Igst Amt (Rs)', field: '' },
      { header: 'Cess Rate (%)', field: '' },
      { header: 'Cess Adval Amt (Rs)', field: '' },
      { header: 'Cess Non Adval Amt (Rs)', field: '' },
      { header: 'State Cess Rate (%)', field: '' },
      { header: 'State Cess Adval Amt(Rs)', field: '' },
      { header: 'state Cess Non-Adval Amt (Rs)', field: '' },
      { header: 'Other Charges', field: '' },
      { header: 'Item Total', field: 'Total' },
      { header: 'Batch Name', field: '' },
      { header: 'Batch Expiry Dt.', field: '' },
      { header: 'Warranty Dt.', field: '' },
      { header: 'Total Taxable Value', field: 'GrandTotal' },
      { header: 'Sgst Amt ', field: '' },
      { header: 'Cgst Amt ', field: '' },
      { header: 'Igst Amt ', field: '' },
      { header: 'Cess Amt', field: '' },
      { header: 'State Cess Amt', field: '' },
      { header: 'Discount', field: '' },
      { header: 'Other Charges', field: '' },
      { header: 'Round off', field: '' },
      { header: 'Total Invoice Value', field: '' },
      { header: 'Shipping Bill No', field: '' },
      { header: 'Shipping Bill Dt', field: '' },
      { header: 'Port', field: '' },
      { header: 'Refund Claim', field: '' },
      { header: 'Foreign Currency', field: '' },
      { header: 'Country Code', field: '' },
      { header: 'Export Duty Amount', field: '' },
      { header: 'Trans ID', field: '' },
      { header: 'Trans Name', field: '' },
      { header: 'Trans Mode', field: '' },
      { header: 'Distance', field: '' },
      { header: 'Trans Doc No', field: '' },
      { header: 'Trans Doc Date', field: '' },
      { header: 'Vehicle No', field: '' },
      { header: 'Vehicle Type', field: '' },
      { header: 'Vehicle No', field: '' },
      { header: 'Error List', field: '' },
      { header: 'Despatch pincode', field: '' }
    ];
  }
}