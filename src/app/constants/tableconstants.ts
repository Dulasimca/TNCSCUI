...
export class TableConstants {
  ...
  constructor() {
    ...
    this.FrozenPDSLiftmentColumns = [
      ...
      { field: 'Name', header: 'Region Name', width: '300px' }
    ]
    ...
    this.EInvoice = [
      { header: 'S.No', field: 'SlNo', width: '15px' },
      { header: 'Supply Type Code', field: 'Sample' },
      { header: 'e-comm GSTIN', field: 'Sample' },
      { header: 'Igst on Intra', field: 'Sample' },
      { header: 'Doument Type', field: 'Sample' },
      { header: 'Document Number', field: 'Dono' },
      { header: 'Document Date (DD/MM/YYYY)', field: 'DoDate' },
      { header: 'Buyer GSTIN', field: 'GSTNumber' },
      { header: 'Buyer Leagal Name', field: 'PartyName' },
      { header: 'Buyer Trade Name', field: 'PartyName' },
      { header: 'Buyer POS', field: 'IssuerCode' },
      { header: 'Buyer addr1', field: 'Address1' },
      { header: 'Buyer addr2', field: 'Address2' },
      { header: 'Buyer Location', field: 'Sample' },
      { header: 'Buyer pincode', field: 'Pincode' },
      { header: 'Buyer state', field: 'StateCode' },
      { header: 'Buyer Phone Number', field: 'Sample' },
      { header: 'Buyer Email ID', field: 'Sample' },
      { header: 'Despatch Name', field: 'Sample' },
      { header: 'Despatch addr1', field: 'Sample' },
      { header: 'Despatch addr2', field: 'Sample' },
      { header: 'Despatch Location', field: 'Sample' },
      { header: 'Despatch State', field: 'Sample' },
      { header: 'Shipping GSTIN', field: 'Sample' },
      { header: 'Shipping Leaga Name', field: 'Sample' },
      { header: 'Shipping Trade Name', field: 'Sample' },
      { header: 'Shipping addr1', field: 'Sample' },
      { header: 'Shipping addr2', field: 'Sample' },
      { header: 'Shipping Location', field: 'Sample' },
      { header: 'Shipping pincode', field: 'Sample' },
      { header: 'Shipping state', field: 'Sample' },
      { header: 'Sl.NO', field: 'Slno' },
      { header: 'Product Description', field: 'ProductDescription' },
      { header: 'Is_Service', field: 'Is_Service' },
      { header: 'HSN Code', field: 'Hsncode' },
      { header: 'Bar Code', field: 'Sample' },
      { header: 'Quantity', field: 'NetWeight' },
      { header: 'Free Quantity', field: 'Sample' },
      { header: 'Reverse Charge', field: 'Sample' },
      { header: 'Unit', field: 'Wtype' },
      { header: 'Unit Price', field: 'Rate' },
      { header: 'Gross Amount', field: 'Total' },
      { header: 'Discount', field: 'Sample' },
      { header: 'Pre Tax Value', field: 'Sample' },
      { header: 'Taxable Value', field: 'Sample' },
      { header: 'GST Rate (%)', field: 'TaxPercentage' },
      { header: 'Sgst Amt (Rs)', field: 'Sample' },
      { header: 'Cgst Amt (Rs', field: 'Sample' },
      { header: 'Igst Amt (Rs)', field: 'Sample' },
      { header: 'Cess Rate (%)', field: 'Sample' },
      { header: 'Cess Adval Amt (Rs)', field: 'Sample' },
      { header: 'Cess Non Adval Amt (Rs)', field: 'Sample' },
      { header: 'State Cess Rate (%)', field: 'Sample' },
      { header: 'State Cess Adval Amt(Rs)', field: 'Sample' },
      { header: 'state Cess Non-Adval Amt (Rs)', field: 'Sample' },
      { header: 'Other Charges', field: 'Sample' },
      { header: 'Item Total', field: 'Total' },
      { header: 'Batch Name', field: 'Sample' },
      { header: 'Batch Expiry Dt.', field: 'Sample' },
      { header: 'Warranty Dt.', field: 'Sample' },
      { header: 'Total Taxable Value', field: 'GrandTotal' },
      { header: 'Sgst Amt ', field: 'Sample' },
      { header: 'Cgst Amt ', field: 'Sample' },
      { header: 'Igst Amt ', field: 'Sample' },
      { header: 'Cess Amt', field: 'Sample' },
      { header: 'State Cess Amt', field: 'Sample' },
      { header: 'Discount', field: 'Sample' },
      { header: 'Other Charges', field: 'Sample' },
      { header: 'Round off', field: 'Sample' },
      { header: 'Total Invoice Value', field: 'Sample' },
      { header: 'Shipping Bill No', field: 'Sample' },
      { header: 'Shipping Bill Dt', field: 'Sample' },
      { header: 'Port', field: 'Sample' },
      { header: 'Refund Claim', field: 'Sample' },
      { header: 'Foreign Currency', field: 'Sample' },
      { header: 'Country Code', field: 'Sample' },
      { header: 'Export Duty Amount', field: 'Sample' },
      { header: 'Trans ID', field: 'Sample' },
      { header: 'Trans Name', field: 'Sample' },
      { header: 'Trans Mode', field: 'Sample' },
      { header: 'Distance', field: 'Sample' },
      { header: 'Trans Doc No', field: 'Sample' },
      { header: 'Trans Doc Date', field: 'Sample' },
      { header: 'Vehicle No', field: 'Sample' },
      { header: 'Vehicle Type', field: 'Sample' },
      { header: 'Vehicle No', field: 'Sample' },
